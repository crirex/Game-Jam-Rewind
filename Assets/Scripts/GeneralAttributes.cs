...
public class GeneralAttributes: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //combinationDictionary.Add(new KeyValuePair<string, string>("Stone", "Fire"), gameObjectsForDictionary[7]); //Metal
        //combinationDictionary.Add(new KeyValuePair<string, string>("Stone", "Metal"), gameObjectsForDictionary[8]); //Gold
